...
TRAIN_DF = getData(TOTAL_COLS, SUBMODEL_NAME, TRAIN_PERIOD).dropna(subset=VARIABLE_COLS).limit(10)
...
TEST_DF = getData(TOTAL_COLS, SUBMODEL_NAME, FORWARD_TEST_PERIOD).dropna(subset=VARIABLE_COLS).limit(10)
